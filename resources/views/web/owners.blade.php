    ...
    <section class="page section-cofounder">
        <div class="container">
            <div class="section-header">
                <h1 class="section-title">Основатели</h1>
            </div>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="cofounder-text owner-text-block">
                                    ...
                                    <ul>
                                        ...
                                        <li>2022 – генеральный директор компании Alyp Group</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                ...
                                <div class="cofounder-text owner-text-block">
                                    <div class="cofounder-name">
                                        <p>Асемханов Мухтар Базылханович</p>
                                        <p>серийный предприниматель, ментор</p>
                                    </div>
                                    <ul>
                                        <li>Ментор</li>
                                        <li>Маркетолог</li>
                                        <li>Актер</li>
                                        <li>В традиционном бизнесе более 30 лет</li>
                                        <li>В сфере МЛМ бизнеса с 2012 года</li>
                                        <li>Основатель и Председатель ПК “Barakyat House”</li>
                                        <li>один из учредителей компани ТОО LIKE MARKETING</li>
                                        <li>один из учредителей компании KYYDSLUCKY</li>
                                        <li>сооснователь компании ALYP GROUP.</li>
                                        <li>Автор обучение “12 основ создание МЛМ бизнеса”.</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                ...
                                <div class="cofounder-text owner-text-block">
                                    <div class="cofounder-name">
                                        <p>Тюменбаева Райхан Жылкыбековна</p>
                                    </div>
                                    <ul>
                                        <li>Учредитель, Руководитель Производства БАДов</li>
                                        <li>Производитель продукций БАД;</li>
                                        <li>В 2018 году запустила производство компании RMAZ и
                                            5 лет компания производит продукцию помогающий
                                            людям достичь благополучия и здоровья.</li>
                                        <li>Сооснователь компании ALYP GROUP.</li>
                                    </ul>
                                </div>
                            </div>
