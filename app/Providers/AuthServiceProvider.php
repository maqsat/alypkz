...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Gate::define('admin_access', function ($user) {
            return $user->admin && in_array($user->role_id, [1,2,3,4]);
        });

        Gate::define('not_cash_bonuses_access', function ($user) {
            return $user->admin && in_array($user->role_id, [1]);
        });
        ...
        Gate::define('admin_reviews_access', function ($user) {
            return $user->admin && in_array($user->role_id, [1,2]);
        });
        ...
        Gate::define('admin_user_processing', function ($user) {
            return $user->admin && in_array($user->role_id, [1,2,3]);
        });
        ...
        Gate::define('admin_user_create', function ($user) {
            return $user->admin && in_array($user->role_id, [1]) || !$user->admin && in_array($user->role_id, [1]);
        });
        ...
        Gate::define('admin_processing_status_update', function ($user) {
            return $user->admin && in_array($user->role_id, [1,3]);
        });
        ...
        Gate::define('admin_activation_user', function ($user) {
            return $user->admin && in_array($user->role_id, [2,1]);
        });
